...
Background: Logging is an an Admin to check statuses
  ...
  Given the following clients exist:
    ...
    | John        | Adams     	| john@adams.com        | oram123         | referrer	    | 'test'                 | 
...
Scenario: Checking if CASF (Client Approval Status Feed) exists (approval)
  Given PENDING
  Given I am on the home page 
  Then I should see "Client Approval Status Feed"
    And I should see "Bryan Adams"
    And I should see "Approved"
    
Scenario: Checking if CASF (Client Approval Status Feed) exists (rejection)
  Given PENDING
  Given I am on the home page 
